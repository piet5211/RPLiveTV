...
namespace RemotePotatoServer
{
    public partial class FormConnectionWizard : Form
    {
        ...
        void TryMoveFromStep1(ref bool cancel, ref string CancelReason)
        {
            ...
            int httpport = Convert.ToInt32(RPPort.Text);
    ...
    (Settings.Default.LastSetSecurityForLiveTVPort != Settings.Default.RPPortWithLiveTV))
        ...
        private void LiveTVPort_ValueChanged(object sender, EventArgs e)
        {
            SettingsProviderNet.Settings.LiveTVSettings set = settingsSaver.GetSettings<SettingsProviderNet.Settings.LiveTVSettings>();
            if ((int)((NumericUpDown)sender).Value == 19909)
            {
                MessageBox.Show("Sorry can't use port 19909, as it is used internally by Remote Potato Live TV, please select another port for your RP server.");
            }
            else
            {
                if (Settings.Default.UsingLiveTV)
                {
                    set.LiveTVPort = (int)((NumericUpDown)sender).Value;
                    settingsSaver.SaveSettings(set);
                    Settings.Default.RPPortWithLiveTV = set.LiveTVPort;
                ...
                {
                    Settings.Default.RPPort = (int)((NumericUpDown)sender).Value;
                    if ((Settings.Default.LastSetSecurityForPort != Settings.Default.RPPort))
                    {
                        ReserveURLForPort();
                    }
        ...
        {
            string target = "http://dnslookup.me/dynamic-dns/";
        ...
        void BindControls()
        {
            ...
            this.InternalPort.DataBindings.Add(new System.Windows.Forms.Binding("Text", Settings.Default, "RPPort", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            this.RPPort.DataBindings.Add(new System.Windows.Forms.Binding("Text", Settings.Default, "RPPortWithLiveTV", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            switch (e.Link.Name)
            {
                case "iOS":
                    ...
                    break;
                case "Android":
                    System.Diagnostics.Process.Start("(http://goo.gl/YeklZ");
                    break;
                case "Windows":
                    System.Diagnostics.Process.Start("http://apps.microsoft.com/windows/nl-nl/app/remote-media-center-live-tv/bcea61e7-c252-45b6-816d-67f419b8bde8");
                    break;
                case "WindowsRT":
                    System.Diagnostics.Process.Start("http://apps.microsoft.com/windows/nl-nl/app/remote-media-center-live-tv-for/c552a2cf-86c4-4737-a3ca-5b07d7e141fd");
                    break;
            }
        }
        ...
        {
            System.Diagnostics.Process.Start("http://myfrem.nl/forum");
