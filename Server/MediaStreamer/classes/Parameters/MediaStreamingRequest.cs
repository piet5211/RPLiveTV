...
namespace FatAttitude.MediaStreamer
{
    ...
    public class MediaStreamingRequest 
    {
        ...
        public int UseSubtitleStreamIndex { get; set; }
        ...
        public bool NewLiveTV { get; set; }
        public bool UseNewerFFMPEG { get; set; }
        public bool OnlyDump { get; set; }
        public bool ClientUsesVLC // used for getting #EXT-X-START in m3u8 file
        {
            get;
            set;
        }
        public bool ClientUsesApple // used for getting #EXT-X-START2 in m3u8 file
        {
            get;
            set;
        }

        public bool OnlyTranscodeOnServer { get; set; }
        public bool KeepSameIDForSameInputFile { get; set; } // In order for android players to recognize ID to be the same s.t. resume possible., also will keep track of current media position for all clients with this bool set

        public Int32 DurationLiveTVBlocks { get; set; }
        public int InitialWaitTimeBeforeLiveTVStarts { get; set; }
        public int SegmentDur { get; set; }
        ...
        public MediaStreamingRequest()
        {
            ...
            //UseSubtitleStreamIndex = 0;// TODO for testing purposes
            UseSubtitleStreamIndex = -1;// TODO for testing purposes
            ClientID = "";
            ClientDevice = "";
            ...
            //EOSDetected = false;
                ...
                public string UniekClientID
        {
            get
            {
                return (UniqueClientID == null ? "CarlsRPClient"+ClientID : UniqueClientID);   
            }
        }
        ...
        public int ActualSegmentDuration
        {
            get
            {
                if (NewLiveTV) return SegmentDur;//1 would be lowest possible latency with HLS, however streaming chokes then
