...
namespace RemotePotatoServer
{
    ...
    public class RPWebServer
    {
		...
		//88888
       public RPWebServer(string name, int port, string path, bool useAuth, object caller)
...
//88888
//                    IAsyncResult result = httpListener.BeginGetContext(new AsyncCallback(this.ProcessHttpRequest), httpListener);
                   IAsyncResult result = httpListener.BeginGetContext(new AsyncCallback(RPWebServer.ProcessHttpRequest), httpListener);
                   //88888
//                                   RemotePotatoServer.Form1.Listener l = new RemotePotatoServer.Form1.Listener(caller);
  //                                 l.Subscribe(rp);
