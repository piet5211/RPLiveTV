...
//888888
        public ThreadController(object caller)
...
//88888
            mainServer = new RPWebServer("Main server", Convert.ToInt32(Settings.Default.RPPort), "/", false, caller);   // create the main server object
