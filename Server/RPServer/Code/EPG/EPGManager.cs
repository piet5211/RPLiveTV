...
namespace RemotePotatoServer
{
    public static class EPGManager
    {
        ...
        public static bool ReloadAllRecordingsForLiveTV()
        {
            return GetAllRecordingScheduleForLiveTV(DAYS_BACK_TO_GET_RECORDINGS, false);
        }

        static object oneEntryAtATime = new object();
